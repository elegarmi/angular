// To parse this data:
//
//   import { Convert, SearchGifsResponseModel } from "./gifs.interface";
//
//   const searchGifsResponseModel = Convert.toSearchGifsResponseModel(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGifsResponseModel {
    data:       Gif[];
...
export class Convert {
    public static toSearchGifsResponseModel(json: string): SearchGifsResponseModel {
        return cast(JSON.parse(json), r("SearchGifsResponseModel"));
    }

    public static searchGifsResponseModelToJson(value: SearchGifsResponseModel): string {
        return JSON.stringify(uncast(value, r("SearchGifsResponseModel")), null, 2);
    }
}
